...
const Details = ({ type, time, place, info }: EductionProps) => {
    ...
    return (
        <div className="my-64">
            ...
            <div ref={ref} className="w-[75%] mx-auto relative lg:w-[90%] md:w-full">
                ...
                {/* <motion.div
                    className="absolute left-9 top-0 w-[4px] h-full bg-black origin-top dark:bg-light md:w-[2px] md:left-[30px] xs:left-[20px]"
